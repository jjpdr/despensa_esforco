...
require_once("DAO/EnderecoEntregaCriteriaDAO.php");

/**
 * The EnderecoEntregaCriteria class extends EnderecoEntregaDAOCriteria and is used
 ...
 * @version 1.0
 */
class EnderecoEntregaCriteria extends EnderecoEntregaCriteriaDAO
{
