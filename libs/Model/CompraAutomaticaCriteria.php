...
require_once("DAO/CompraAutomaticaCriteriaDAO.php");

/**
 * The CompraAutomaticaCriteria class extends CompraAutomaticaDAOCriteria and is used
 ...
 * @version 1.0
 */
class CompraAutomaticaCriteria extends CompraAutomaticaCriteriaDAO
{
