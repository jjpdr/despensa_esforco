...
require_once("DAO/ProdutoCriteriaDAO.php");

/**
 * The ProdutoCriteria class extends ProdutoDAOCriteria and is used
 ...
 * @version 1.0
 */
class ProdutoCriteria extends ProdutoCriteriaDAO
{
