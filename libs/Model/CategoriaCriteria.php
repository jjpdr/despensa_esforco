...
require_once("DAO/CategoriaCriteriaDAO.php");

/**
 * The CategoriaCriteria class extends CategoriaDAOCriteria and is used
 ...
 * @version 1.0
 */
class CategoriaCriteria extends CategoriaCriteriaDAO
{
