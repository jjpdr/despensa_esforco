...
require_once("DAO/MetodoPagamentoCriteriaDAO.php");

/**
 * The MetodoPagamentoCriteria class extends MetodoPagamentoDAOCriteria and is used
 ...
 * @version 1.0
 */
class MetodoPagamentoCriteria extends MetodoPagamentoCriteriaDAO
{
