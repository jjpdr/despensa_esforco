<?php
/**
 * @package Despesnsa Esforço v1.0 
 *
...
GlobalConfig::$CONNECTION_SETTING->DBName = "despensa_esforco";
...
/** the root url of the application with trailing slash, for example http://localhost/despesnsa esforço v1.0 / */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'despensaesforco_v10/';
